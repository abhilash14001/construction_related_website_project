...
if (isset($postdata ['key'])) {
	...
	$CalcHashString 	= 	strtolower(hash('sha512', $status.'|'.$reverseKeyString));
...
$marble->insertData("stone_category_order_history", $query);


	$last = mysqli_insert_id($con);
	$mobile = $_SESSION['mobile'];
$marble->insertData("payu", "NULL, '$last', '$txnid', '$amount','$productInfo','$firstname','$email','$mobile'");
...
header("location:$home/order_confirm/");
