...
$marble->alert("Please Login to Continue");	
?>
	<!-- ======================================
			...
			<div class="row">
				<div class="col-md-5 col-md-offset-1 col-sm-6" >
					<div class="login_form wow slideInLeft" >
						...
						<form action="actions/login.php?id=<?php echo $getid;?>" method="post" >
						
							<div class="login_name" >
								<label for="login_name">
								Enter your email<span>*</span>
								</label>
								<input type="text" value = "abhilash@gmail.com" name = "emails" id="login_name" required>
							</div>
							<div class="login_pwd">
								<label for="login_password">
								Enter your password<span>*</span>
								</label>
								<input type="password" value = "abhi123" name = "passwords" id="login_password" required>
							</div>
					...
					<div class="login_name">
						...
						<div class="click_list">
							...
							<a href="<?php echo HOME_URL;?>register.php">New User ?<span> Register Now</span></a>
						</div>
					</div>
				</div>
