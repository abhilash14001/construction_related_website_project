...
$ongoingproject = $marble->fetchData("*", "construction where status = 'ongoing'");
					...
					<div class="supplier_country">
						<div class="country">
							<ul>
								...
								<li><a href="#">Completed projects and tenders</a></li>
							</ul>
						</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="title_style">
						<h1>Completed projects and tenders</h1>
					</div>
				</div>
			</div>
			<div class="row">
			...
			{ extract($row);
				...
				<div class="col-sm-4 col-xs-12">
					<div class="export_item " >
						...
						<img style  = "width:200px; height:150px"  id = "image" src="<?php echo ADMIN_URL;?>construction/images/<?php echo $image[0];?>" alt="export">
