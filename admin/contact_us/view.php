...
include "../include/header.php";
 $fetch = $marble->fetchData("*", "contact_us");
...
<td>'.$message.'</td>';
?>
<td><a type = "button" onclick = "confirmDelete(<?php echo $id; ?>, this)" href = "#" class="btn btn-danger confirmdelete"><span class = "fas fa-trash"></span>&nbsp;<font color="white">Del</font></a></td>
</tr>
<?php
