...
$fetch = $marble->fetchData("*", "products");
$i=0;
...
echo '
<td>'.$marble->getCategoryName($category_id).'</td>
<td>'.$marble->getCategoryName($sub_category_id).'</td>
<td>'.$description.'</td>
<td>'.$price.'</td>
<td>'.$volume.'</td>';
?>
...
<div class = "btn-grp">
	<a href ="editproduct.php?id=<?php echo $id; ?>" class="editbtn btn btn-success btn btn-sm"><span class = "fas fa-pencil-alt"></span></a>
 <a type = "button" onclick = "confirmDelete(<?php echo $id; ?>, this)" href = "#" class="btn btn-danger btn btn-sm confirmdelete"><span class = "fas fa-trash"></span>&nbsp;</a>
 </div>
</td>
